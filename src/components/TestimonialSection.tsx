    ...
    <div className="relative z-10 w-full flex flex-col items-start mb-16 lg:flex-row lg:items-center lg:justify-start lg:gap-x-12 ">
      <div className="flex flex-col  w-full lg:flex-1">
        ...
        <div className="flex justify-between flex-wrap-reverse lg:flex-nowrap m-0">
          <div className="lg:flex-shrink-0 lg:w-20 lg:h-20 flex justify-center items-center mb-6 lg:mb-0 self-end mr-6">
            <img className="w-12 h-12" alt="Vector" src="/vector2.svg" />
          </div>
          <div
            className="w-full flex flex-row justify-start gap-x-6 overflow-x-auto pb-4 no-scrollbar cursor-grab"
            ref={carouselRef}
          ...
          >
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="flex-shrink-0 md:min-w-[300px] md:max-w-[420px] h-[136px] h-[180px] max-w-[220px]"
                onClick={handleClick}
              >
