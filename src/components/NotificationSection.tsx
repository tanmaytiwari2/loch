...
export const NotificationSection = () => {
  return (
    <div className="relative z-10 flex flex-col lg:flex-row justify-between w-full mt-16 mb-12 gap-8 lg:pl-8">
      ...
      <div className="relative flex-shrink lg:pl-0 h-[180px] overflow-x-auto overflow-y-hidden rounded-l-2xl ">
        ...
        <div className="absolute inset-0 pointer-events-none lg:shadow-[58px_2px_65px_-9px_rgba(0,0,0,0.69)_inset] rounded-l-2xl " />
      </div>
    </div>
  );
};
