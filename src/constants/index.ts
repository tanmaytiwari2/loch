export const NOTIFICATION_CONSTANTS = {
  HEADLINE: "Get notified when a highly correlated whale makes a move",
  DESCRIPTION:
...
export const TESTIMONIAL_CONSTANTS = [
  ...
  },
  {
    ...
    quote:
      '"I use Loch everyday now. I dont think I could analyze crypto whale trends markets without it. I am addicted!"',
  },
  {
    name: "Shiv S",
    position: "Co-Founder Magik Labs",
    quote:
      '"Managing my own portfolio is helpful and well designed. Whats really interesting is watching the whales though. No one else has made whale tracking so simple."',
  },
];

export const WHALE_WATCHING_CONSTANTS = {
  HEADLINE: "Watch what the whales are doing",
  DESCRIPTION:
